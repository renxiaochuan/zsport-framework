package com.zsport.platform.userservice.service;
...
import com.zsport.platform.userservice.dao.UserDao;
import com.zsport.platform.userservice.dto.LoginDTO;
import com.zsport.platform.userservice.entity.JWT;
import com.zsport.platform.userservice.entity.User;
import com.zsport.platform.userservice.util.BPwdEncoderUtils;
...
public class UserService {
    ...
    public RespDTO login(String username , String password){
       ...
       if(!BPwdEncoderUtils.matches(password,user.getPassword())){
        ...
        JWT jwt = authServiceClient.getToken("Basic dWFhLXNlcnZpY2U6cm9vdA==", "password", username, password);
        // 获得用户菜单
        if(null==jwt){
